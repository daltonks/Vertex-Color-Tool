...
This tool lets you change vertex colors in Edit mode, using simple selections and a minimalist UI. It works with RGB **and alpha** and translates well to Unity or Unreal Engine, for instance. Tested on Blender 4.5.3 LTS, should work fine with other releases.
